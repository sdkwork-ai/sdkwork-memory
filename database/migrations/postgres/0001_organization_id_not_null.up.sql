...
ALTER TABLE ai_space ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE ai_subject ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
