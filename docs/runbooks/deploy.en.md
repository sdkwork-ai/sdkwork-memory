# Runbook — sdkwork-memory deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-memory-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-memory/bundle`, loads the image, starts
