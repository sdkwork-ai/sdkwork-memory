...
Module `sdkwork-memory` · runtime code `memory` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 65 | `memory-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 65 | `memory-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 65 | `memory-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 65 | `memory-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 65 | `memory.sdkwork.com` | 443 ssl + 80 |
